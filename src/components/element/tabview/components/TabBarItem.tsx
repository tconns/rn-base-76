...
const TabBarItem = (props: TabBarItemProps) => {
  ...
  const activeLabel = useMemo(() => {
    ...
    return (
      <Animated.Text style={[styles.activeLabel, animatedActiveLabelStyle, activeColorStyle, labelStyle]}>
        {getLabelText?.({ route })}
      </Animated.Text>
    )
  ...
  const inactiveLabel = useMemo(() => {
    ...
    return (
      <Animated.Text style={[styles.inactiveLabel, animatedInactiveLabelStyle, inactiveColorStyle, labelStyle]}>
        {getLabelText?.({ route })}
      </Animated.Text>
    )
  }, [inactiveColor, animatedInactiveLabelStyle, getLabelText, labelStyle, route])
